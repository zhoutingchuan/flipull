...
public class EggMovingDownBehavior implements MovingBehavior
{
    ...
    public EggMovingDownBehavior(Egg egg)
    {
        this.egg = egg;
    }
    ...
    public void move()
    {
        ...
        if (y <= GameConstant.Egg.EGG_Y_BOTTOM)
        {
            y = GameConstant.Egg.EGG_Y_BOTTOM;
        }
